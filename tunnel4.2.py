...
def start_cloudflared_tunnel(cloudflared: str, local_ip: str, local_port: int, proto: str,
    ...
    for attempt in range(1, max_retries + 1):
        ...
        for line in process.stdout:
            ...
            # 检查是否获取到隧道 URL
            # Cloudflare Quick Tunnel 说明：所有协议（包括 TCP）都输出 https://xxx.trycloudflare.com 格式
            # TCP 协议需要客户端使用 cloudflared access tcp 连接
        ...
        for attempt in range(1, max_retries + 1):
            ...
            try:
                ...
                for line in self.process.stdout:
                    ...
                    # Cloudflare Quick Tunnel 说明：所有协议都输出 https://xxx.trycloudflare.com 格式
                    match = re.search(r'(https://[a-zA-Z0-9\-]+\.trycloudflare\.com)', line)
                    if match:
